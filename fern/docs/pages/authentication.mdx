...
![Click on your name, then the account menu](/docs/assets/account-menu.png)

3. On the "Account" popup, select the "API" tab on the left hand side. 

![Select the API tab in the account dialog](/docs/assets/account-dialog.png)

4. Select the API V4 section and click "Create API Key". 

![Click Create API Key, then type in the key name](/docs/assets/create-api-key-dialog.png)
...
![Revoke API key](/docs/assets/revoke-api-key.png)
